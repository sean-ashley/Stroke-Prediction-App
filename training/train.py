...
def build_pipeline():
    ...
    parameters = {
       ...
       "pred__max_delta_step": list(range(1,11))
      
   }        
   
    grid = GridSearchCV(pipeline, param_grid=parameters,n_jobs = -1 ,scoring ="average_precision")
...
# evaluate model
    ...
    print("AUCPR Score: {}".format(precision_recall_curve(y_test,y_proba)))
